...
public class OrderJpaAdapterTest {
    ...
    public void test_save_order_with_multiple_dishes_success() {
        // Arrange
        Order order = new Order(1L, "client1", "rest1", LocalDateTime.now(), "PENDING", null, "123456",
                Arrays.asList(new OrderDish(1L, 2), new OrderDish(2L, 1)));

        OrderEntity orderEntity = new OrderEntity(1L, "client1", "rest1", LocalDateTime.now(), "PENDING", "025663", null);
    ...
    public void test_list_orders_with_valid_filters() {
        ...
        OrderEntity orderEntity = new OrderEntity(1L, "client1", nit, LocalDateTime.now(), estado, "025663", "chef1");
        ...
        Order order = new Order(1L, "client1", nit, LocalDateTime.now(), estado, "chef1","123456", new ArrayList<>());
    ...
    public void test_list_orders_when_estado_is_null() {
        ...
        OrderEntity orderEntity = new OrderEntity(1L, "client1", nit, LocalDateTime.now(), null, "025663", "chef1");
        List<OrderEntity> orderEntities = Collections.singletonList(orderEntity);

        OrderDishEntity orderDishEntity = new OrderDishEntity();
        List<OrderDishEntity> orderDishEntities = Collections.singletonList(orderDishEntity);

        Order order = new Order(1L, "client1", nit, LocalDateTime.now(), null, "chef1", "123456", new ArrayList<>());
        OrderDish orderDish = new OrderDish(1L, 2);
        List<OrderDish> orderDishes = Collections.singletonList(orderDish);
    ...
    public void test_sorts_results_ascending_when_is_ascending_true() {
        ...
        OrderEntity orderEntity1 = new OrderEntity(1L, "client1", nit, LocalDateTime.now().minusDays(1), estado, "025663", "chef1");
        OrderEntity orderEntity2 = new OrderEntity(2L, "client2", nit, LocalDateTime.now(), estado, "025663", "chef2");
        List<OrderEntity> orderEntities = Arrays.asList(orderEntity1, orderEntity2);

        OrderDishEntity orderDishEntity = new OrderDishEntity();
        List<OrderDishEntity> orderDishEntities = Collections.singletonList(orderDishEntity);

        Order order1 = new Order(1L, "client1", nit, LocalDateTime.now().minusDays(1), estado, "chef1","123456", new ArrayList<>());
        Order order2 = new Order(2L, "client2", nit, LocalDateTime.now(), estado, "chef2", "123456", new ArrayList<>());
        OrderDish orderDish = new OrderDish(1L, 2);
        List<OrderDish> orderDishes = Collections.singletonList(orderDish);
    ...
    public void test_get_order_by_id_returns_mapped_order_when_exists() {
        ...
        Order expectedOrder = new Order(1L, "client1", "nit1", LocalDateTime.now(), "PENDING", "chef1", "123456", new ArrayList<>());
    ...
    public void test_update_order_success() {
        // Arrange
        Order order = new Order(1L, "client1", "nit123", LocalDateTime.now(), "PENDING", "chef1","123456", new ArrayList<>());
        OrderEntity orderEntity = new OrderEntity(1L, "client1", "nit123", LocalDateTime.now(), "PENDING", "025663", "chef1");
        OrderEntity savedOrderEntity = new OrderEntity(1L, "client1", "nit123", LocalDateTime.now(), "PENDING", "025663", "chef1");
        List<OrderDishEntity> orderDishEntities = new ArrayList<>();
        Order mappedOrder = new Order(1L, "client1", "nit123", LocalDateTime.now(), "PENDING", "chef1","123456", new ArrayList<>());
